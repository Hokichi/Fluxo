...
public sealed class TransactionDetailPopupSplitLayoutTests
{
    private static readonly string PopupXamlPath = RepositoryPaths.File(
        "Fluxo",
        "Views",
        "Popups",
        "TransactionDetailPopup.xaml");
    ...
    [Fact]
    public void TransactionDetailPopup_WiresSplitButtonAndHandlers()
    {
    ...
    [Fact]
    public void TransactionDetailPopup_SplitSaveReturnsToViewModeWithoutClosingPopup()
    {
        var codeBehind = File.ReadAllText(PopupCodeBehindPath);
    ...
    [Fact]
    public void TransactionDetailPopup_SplitModeLayout_HidesNormalFieldsAndShowsSplitRows()
    {
        var xaml = File.ReadAllText(PopupXamlPath);
        ...
        Assert.Contains("Split amounts exceed the original transaction amount.", xaml);
    ...
    [Fact]
    public void TransactionDetailPopup_NormalLayout_PutsNameAndPinAboveAmount()
    {
        var xaml = File.ReadAllText(PopupXamlPath);
        var codeBehind = File.ReadAllText(PopupCodeBehindPath);
    ...
    [Fact]
    public void TransactionDetailPopup_ChildTransactionsPanel_IsRightSideScrollableList()
    {
        var xaml = File.ReadAllText(PopupXamlPath);
        var codeBehind = File.ReadAllText(PopupCodeBehindPath);
