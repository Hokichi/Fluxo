...
namespace Fluxo.Data.Migrations
{
    ...
    [Migration("20260331080056_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Fluxo.Data.Entities.Expense", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Fluxo.Data.Entities.ExpenseLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Fluxo.Data.Entities.ExpenseTag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Fluxo.Data.Entities.SavingGoal", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Fluxo.Data.Entities.SpendingSource", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Fluxo.Data.Entities.Expense", b =>
                {
                    b.HasOne("Fluxo.Data.Entities.ExpenseTag", "ExpenseTag")
                        .WithMany()
                        .HasForeignKey("ExpenseTagId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Fluxo.Data.Entities.SpendingSource", "SpendingSource")
                        .WithMany()
            ...
            modelBuilder.Entity("Fluxo.Data.Entities.ExpenseLog", b =>
                {
                    b.HasOne("Fluxo.Data.Entities.Expense", "Expense")
                        .WithMany()
