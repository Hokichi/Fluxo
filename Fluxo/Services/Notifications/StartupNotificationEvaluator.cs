    ...
    Func<DateTime>? clock = null)
{
    ...
    private Task<StartupNotificationEvaluation> EvaluateAsync(
        ...
        dataOperationRunner.RunAsync(async (scope, ct) =>
        {
            ...
            if (requestedKind is not NotificationEntityKind.Account and not NotificationEntityKind.SavingGoal)
            ...
            if (requestedKind is not NotificationEntityKind.Account and not NotificationEntityKind.RecurringTransaction)
