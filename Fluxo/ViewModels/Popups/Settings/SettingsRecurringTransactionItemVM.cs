...
public partial class SettingsRecurringTransactionItemVM : ObservableObject
{
    [ObservableProperty] private bool _isChecked;
    [ObservableProperty] private bool _isSelected;

    public SettingsRecurringTransactionItemVM(RecurringTransaction recurringTransaction)
    {
        Id = recurringTransaction.Id;
        Name = recurringTransaction.Name;
        Amount = recurringTransaction.Amount;
        TagName = recurringTransaction.Tag?.Name ?? "Untagged";
        AccountName = recurringTransaction.Source?.Name ?? "No source";
